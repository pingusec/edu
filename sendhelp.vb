...
Module Program
    ...
    Sub DrawCard(ByVal StartCard As Integer(), ByVal CardX As Integer, ByVal CardY As Integer, ByVal Card As Card)
        ...
        If Len(Card.CardFace.CardWord) = 1 Then
            Console.Write(Card.CardFace.CardWord)
        ElseIf Card.CardFace.CardWord = "10" Then
    ...
    Function LoadFaces() As Face()
        ...
        FileOpen(1, "S:\CardDots.txt", OpenMode.Input)
    ...
    Function LoadDots() As String()
        ...
        FileOpen(1, "S:\AllPositions.txt", OpenMode.Input)
    ...
    Function GenRndNum(z As Integer)
        Return Int(z * Rnd() + 1)
    End Function
    Sub DrawCardDots(StartCard() As Integer, Card As Card)
        Dim TempXY() As String

        For i = 0 To Card.CardFace.DotPos.Length - 1
            TempXY = Split(DotCoords(Card.CardFace.DotPos(i)), ",")

            Console.SetCursorPosition(StartCard(0) + TempXY(0), StartCard(1) = TempXY(1))
            Console.Write(Card.CardSuit.SymbolChar)
        Next
    End Sub
End Module
